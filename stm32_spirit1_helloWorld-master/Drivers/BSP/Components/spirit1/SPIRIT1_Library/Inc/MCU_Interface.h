...
void RadioEnterShutdown(void); //void EnterShutdown(void); -- MKM
void RadioExitShutdown(void); //void ExitShutdown(void); -- MKM
SpiritFlagStatus RadioCheckShutdown(void); //SpiritFlagStatus CheckShutdown(void); -- MKM
